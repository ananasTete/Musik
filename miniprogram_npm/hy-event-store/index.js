...
__DEFINE__(1646035639765, function(require, module, exports) {
module.exports = {
  HYEventBus: require('./event-bus'),
  HYEventStore: require('./event-store')
}

}, function(modId) {var map = {"./event-bus":1646035639766,"./event-store":1646035639767}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646035639766, function(require, module, exports) {
class HYEventBus {
  constructor() {
    this.eventBus = {}
  }
...
__DEFINE__(1646035639767, function(require, module, exports) {
...
}, function(modId) { var map = {"./event-bus":1646035639766,"./utils":1646035639768}; return __REQUIRE__(map[modId], modId); })
__DEFINE__(1646035639768, function(require, module, exports) {
...
return __REQUIRE__(1646035639765);
})()
